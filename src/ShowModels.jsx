...
Para ser visualizada, esta superfície foi projetada ortogonalmente no espaço euclidiano tridimensional
$$
\\mathrm{Re}(x) \\times \\mathrm{Im}(x) \\times \\left(\\dfrac{- {\\mathrm{Re}}(y) + {\\mathrm{Im}}(y)}{\\sqrt{2}}\\right)
$$

Pontos de cores diferentes indicam que são pontos com coordenada $\\dfrac{{\\mathrm{Re}}(y)+ {\\mathrm{Im}}(y)}{\\sqrt 2}$ diferentes.

Essa é mesma ilustração da **Cúbica II** (ilustração anterior) mas, em uma projeção tridimensional diferente.`,
    title: "Cúbica III",
  },
  {
    file: "cilindro_I.ply",
